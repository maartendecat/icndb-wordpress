...
$.icndb.getCategories=function(callback){var success=function(result){callback(result.value);};var url=full("categories");callServer(url,success,function(){});}
...
if(args.lastName){url+="&lastName="+args.lastName;}
if(args.limitTo){url+="&limitTo=["+args.limitTo.toString()+"]";}else if(args.exclude){url+="&exclude=["+args.exclude.toString()+"]";}
callServer(url,success,function(){});};})(jQuery);
